<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tokrngenerator.aspx.cs" Inherits="tokrngenerator" %>
  ...
  <form id="form2" runat="server">
	<div class="wrapper">
							...
							<div class="dropdown-menu quick-actions quick-actions-info animated fadeIn">
								...
								<div class="quick-actions-scroll scrollbar-outer">
									<div class="quick-actions-items">
										<div class="row m-0">
											<a class="col-6 col-md-4 p-0" href="#view">
												<div class="quick-actions-item">
													<i class="flaticon-file-1"></i>
													<span class="text">File View</span>
												</div>
											</a>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="#tokengenerate">
											<span class="sub-item">Token Generate</span>
										</a>
									</li>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									<li>
										<a href="#encrypt">
											<span class="sub-item">View Encrypted Index</span>
										</a>
									</li>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-0">
								...
								<a href="#tokengenerate" class="btn btn-secondary btn-round">
                              Token Generate
                              </a>
							</div>
						</div>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            ...
                            <h2 class="text-white pb-2 fw-bold"></h2>
								<h2 class="text-white pb-2 fw-bold">Token Generator</h2>
								<h5 class="text-white op-7 mb-2">Supporting Multi data store application</h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
							 <a href="#tokengenerate" class="btn btn-secondary btn-round">
       ...
       con = new System.Data.SqlClient.SqlConnection(ConfigurationManager.AppSettings["dbconn"]);
        ...
        string sa = "select * from filelist where status='"+status+"'";
     ...
     <td><%=dr["location"].ToString()%></td>
      ...
      %> 
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">Uploaded File In Cloud </div>
        ...
        sa = "select * from filelist where status='"+status+"'";
           cmd = new System.Data.SqlClient.SqlCommand(sa, con);
...
<div class="content" id="tokengenerate">
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
                            <h2 class="text-white pb-2 fw-bold"></h2>
								<h2 class="text-white pb-2 fw-bold">Token Generate</h2>
								<h5 class="text-white op-7 mb-2">Supporting Multi data store application</h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
							<a href="#tokengenerate" class="btn btn-secondary btn-round">
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">File Details</div>
									<div class="card-category">Generte Token</div>
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div class="table-responsive">
  ...
  <tr>
    ...
    <td><%=dr["keys"].ToString()%></td>
     <td><%=dr["location"].ToString()%></td>
     <td><a href="tokengenerate.aspx?id=<%=dr["fid"].ToString()%>&keys=<%=dr["keys"].ToString()%>" class="btn btn-secondary btn-round">Token Generate</a></td>
    </tr>
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">File Details</div>
									<div class="card-category">Encrypted Index</div>
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div class="table-responsive">
