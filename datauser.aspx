<%@ Page Language="C#" AutoEventWireup="true" CodeFile="datauser.aspx.cs" Inherits="datauser" %>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-0">
								<a href="#upload" class="btn btn-white btn-border btn-round mr-2">File Searching</a>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-0">
								...
								<a href="#upload" class="btn btn-secondary btn-round">File serach</a>
							</div>
						</div>
					</div>
				</div>
                                                  ...
                                                  <asp:TextBox ID="TextBox1" class="form-control" runat="server" >
                                                         ...
                                                         <div class="form-group">
                                                             ...
                                                             <asp:Button ID="Button1"  runat="server" Text="Search" 
                                                                 onclick="Button1_Click"  class="btn btn-secondary btn-round" />
                                                          			</div>
                                                                    </div>
									</div>
								</div>
